...
def record_attendance():
    ...
    try:
        ...
        sql = "CREATE TABLE " + table_name +"(uid DECIMAL(2,0)  PRIMARY KEY, na VARCHAR(20) UNIQUE NOT NULL, attendance VARCHAR(30) DEFAULT 'Absent',time VARCHAR(20) DEFAULT 'Not Entered');"
    ...
    ins = "INSERT INTO " + table_name + "(uid, na) SELECT user_id, name FROM primary_details WHERE user_id NOT IN(SELECT uid FROM "+table_name+");"
